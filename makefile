...
DungeonBuilder.jar: *.java plugin.yml CommandMap.xml
	javac -d . -Xlint:unchecked -cp "server/lib/craftbukkit-1.2.4-R1.0.jar:server/plugins/Permissions/Permissions.jar:server/plugins/Heroes.jar:." -Xlint:deprecation *.java
